package com.Nijen.expensetracer.expensetracer.providers;
...
public final class ExpensesContract {
     ...
     */
    public static final String AUTHORITY = "com.github.Nijen.expensetracer.provider";
    /**
    ...
    public static class Categories implements BaseColumns, CategoriesColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.Nijen.expensetracer.provider.expense_category";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single category.
         */
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.Nijen.expensetracer.provider.expense_category";
    ...
    public static class Expenses implements BaseColumns, ExpensesColumns {
        ...
        */
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.Nijen.expensetracer.provider.expense";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single expense.
         */
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.Nijen.expensetracer.provider.expense";
    ...
    public static class ExpensesWithCategories implements BaseColumns {
         ...
         */
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.Nijen.expensetracer.provider.expense_with_category";

        /**
         * The MIME type of a {@link #CONTENT_URI} sub-directory of a single expense with a category.
         */
//        public static final String CONTENT_ITEM_TYPE =
//                "vnd.android.cursor.item/vnd.Nijen.expensetracer.provider.expense_with_category";
